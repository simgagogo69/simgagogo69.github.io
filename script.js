...
//findtree
  ...
  applyStats();
    ...
    { tier: 6, skills: [
      { name: "Instinct", desc: "Double dmg under 10% HP.", cost: 2, type: "passive", effect: () => {checkInstinctTrigger();} },
...
player.shieldRegenTimer = 0;
  ...
  sorcery: [
    ...
    { tier: 2, skills: [{ name: "Pulse", desc: "Deals AoE knockback & slows enemies.", cost: 1, type: "active", effect: () => {} }] },
